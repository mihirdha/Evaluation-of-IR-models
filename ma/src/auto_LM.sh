...
#	do                  
#		b=`expr "$b + 1" | bc`;
		str="683s/.*/<float name=\"mu\">$k1<\/float>/"
		...
		./trec_eval -q -c -M 1000 -m ndcg qrel.txt res/1.txt>res/ndcg-`echo $k1`.txt
		./trec_eval -q -c -M 1000 -m map qrel.txt res/1.txt>res/map-`echo $k1`.txt
		./trec_eval -q -c -M 1000 -m set_F.0.5 qrel.txt res/1.txt>res/set_F.0.5-`echo $k1`.txt
